        ...
        <div class="all">
            ...
            <div class="account-page"> 
                <div class="container">
                    <div class="row">
                        <div class="col-2">
                            <img id="only" src="${sessionScope.account.getImage()==null?"images/2.png":sessionScope.account.getImage()}" width="100%">
                        ...
                        <div class="col-2">
                            <div class="form-container" style=" ${sessionScope.account.getRoleID()==2?"height: 470px":""}">
                                <div class="form-btn">
                                    <span>Account</span>
                                    <hr id="Indicator" style='transform: translateX(0);'>
                                </div>
                                <form id="LoginForm" style='left: 0; transform: translateY(-50px);' action="changetail">
                                    <p style="text-align: left; margin-left: 5px;">Role:</p>
                                    <input style="padding-left: 5px;" type="text" readonly="true" value="${sessionScope.account.getRo().getName()}">
                                    <p style="text-align: left; margin-left: 5px;">Username:</p>         
                                    <input style="padding-left: 5px;" type ="text" readonly="true" value="${sessionScope.account.getUsername()}">
                                    <p style="text-align: left; margin-left: 5px;">Password:</p>
                                    <input style="padding-left: 5px;" type="password" placeholder="Password" value="${sessionScope.account.getPassword()}" name="pass">
                                    <p style="text-align: left; margin-left: 5px; ${sessionScope.account.getRoleID()!=2?"display: none;":""}">Address:</p>
                                    <textarea name="address" placeholder="Address"
                                              style="width: 100%; ${sessionScope.account.getRoleID()!=2?"display: none;":""}">${sessionScope.account.getAddress()}</textarea>
