    ...
    <body>
        ...
        <div class="header">
            <div class="container" style="padding-bottom: 100px;">
                ...
                <div class="row">
                    <img style="width: 70%; margin: auto;" src="images/for shop.png"/>
                </div>
                <div style="transform: translate(55%, -500%);width: 40%;">
                    <h1>${name}</h1>
                    <h2>Authentic</h2>
                </div>
        ...
        <div class="small-container">
            <h2 class="title" style="margin-top: 5%;">Our Products</h2>
            <div class="row">
