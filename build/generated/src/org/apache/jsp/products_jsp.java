...
public final class products_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <input style=\"width: inherit;height: inherit; margin-left: 5%;\" type=\"radio\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.condition==null || sessionScope.condition=='1'?'checked':\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("  name=\"condition\" value=\"1\"> Available <br>\n");
      out.write("                    <input style=\"width: inherit;height: inherit; margin-left: 5%;\" type=\"radio\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.condition=='0'?'checked':\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" name=\"condition\" value=\"0\"> Sold out <br>\n");
      ...
      out.write("                        <input type=\"radio\" name=\"stars\" id=\"star1\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.stars=='5'?'checked':\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" value=\"5\"/>\n");
      ...
      out.write("                        <input type=\"radio\" name=\"stars\" id=\"star2\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.stars=='4'?'checked':\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" value=\"4\"/>\n");
      ...
      out.write("                        <input type=\"radio\" name=\"stars\" id=\"star3\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.stars=='3'?'checked':\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" value=\"3\"/>\n");
      ...
      out.write("                        <input type=\"radio\" name=\"stars\" id=\"star4\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.stars=='2'?'checked':\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" value=\"2\"/>\n");
      ...
      out.write("                        <input type=\"radio\" name=\"stars\" id=\"star5\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.stars=='1'?'checked':\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" value=\"1\"/>\n");
      ...
      out.write("                        <input style=\"width: 40%;\" type=\"number\" step=\"0.01\" name=\"from\" min=\"0\" placeholder=\"$ Min\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.from==null?'':sessionScope.from}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\">\n");
      out.write("                        <p style=\"width: 20%;font-size: 2.5em;text-align: center;\">-</p> \n");
      out.write("                        <input style=\"width: 40%;\" type=\"number\" name=\"to\" min=\"0\" placeholder=\"$ Max\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.to==null?'':sessionScope.to}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\">\n");
      out.write("                    </div>\n");
      out.write("\n");
      out.write("                    <p>Name</p>\n");
      out.write("                    <input type=\"text\" placeholder=\"Search...\" name=\"name\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.name==null?'':sessionScope.name }", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\"/>\n");
      out.write("                    <p>Sort</p>\n");
      out.write("                    <select style=\"width: 100%;\" name=\"sort\">\n");
      out.write("                        <option value=\"default\">Default shorting</option>\n");
      out.write("                        <option ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.sort==\"order by price asc\"?'selected':''}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" value=\"order by price asc\">Short by price - Ascending</option>\n");
      out.write("                        <option ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.sort==\"order by price desc\"?'selected':''}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" value=\"order by price desc\">Short by price - Descending</option>\n");
      out.write("                        <option ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.sort==\"order by stars asc\"?'selected':''}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" value=\"order by stars asc\">Short by rating - Ascending</option>\n");
      out.write("                        <option ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.sort==\"order by stars desc\"?'selected':''}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" value=\"order by stars desc\">Short by rating - Descending</option>\n");
      out.write("                        <option ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.sort==\"order by ODQuantity asc\"?'selected':''}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" value=\"order by ODQuantity asc\">Short by sale - Ascending</option>\n");
      out.write("                        <option ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.sort==\"order by ODQuantity desc\"?'selected':''}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" value=\"order by ODQuantity desc\">Short by sale - Descending</option>\n");
      out.write("                    </select>\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("            <div class=\"small-container\" style=\"margin-top: 0; margin-left: 25%;\">\n");
      out.write("                <div class=\"row row-2\">\n");
      out.write("                    <h2 style=\"margin-left: 43%;\">All Products</h2>\n");
      out.write("                </div>\n");
      out.write("                ");
  ...
  private boolean _jspx_meth_c_forEach_0(PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\n");
          out.write("                        <input style=\"width: inherit;height: inherit; margin-left: 5%;\" ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.forNext.contains(c.getID())?'checked':\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write(" type=\"checkbox\" name=\"cat\" value=\"");
  ...
  private boolean _jspx_meth_c_forEach_2(PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\n");
          out.write("                        <span onclick=\"location.href = 'filter?page=");
