...
//        processRequest(request, response);
        int id_raw = Integer.parseInt(request.getParameter("catid"));

        ProductDAO p = new ProductDAO();
        List<Product> list = p.getByCategoryID(id_raw);
        ...
        request.setAttribute("choose", id_raw);
        request.setAttribute("data", list1);
        request.setAttribute("page", page);
        request.setAttribute("num", num);
        request.getRequestDispatcher("productsTab.jsp").forward(request, response);
    }
