 ...
 * @author Admin
 */
@WebServlet(name = "UpdateAccountServlet", urlPatterns = {"/upacc"})
...
//        processRequest(request, response);
        ...
        Account acc = adb.getAccountById(id);
...
//        processRequest(request, response);
        ...
        AccountDAO adb = new AccountDAO();
        Account real = adb.getAccountById(id);
        
        if(address==null) {
            adb.updatePass(real, pass);
        } else {
            adb.updatePaD(a=real, pass, address);
        }
