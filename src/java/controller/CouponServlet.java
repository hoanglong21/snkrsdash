...
//        processRequest(request, response);
        ...
        if (cou.equalsIgnoreCase("loveyou3000") || cou.equalsIgnoreCase("sigmaduck")) {
            request.setAttribute("mess", "Valid code!");
        } else {
            request.setAttribute("mess", "Invalid code, try again!");
        }
