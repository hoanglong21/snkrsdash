        ...
        <div class="small-container">
            <div class="row row-2">
                ...
                <select>
                    ...
                    <c:set value="${choose}" var="choose"/>
                    <c:forEach items="${dataCat}" var="c">
                        <option ${choose==c.getID()?"selected":""} onclick="location.href = 'tab?catid=${c.getID()}'">${c.getName()}</option>
                    </c:forEach> 
                </select>
            </div>
            ...
            <div class="page-btn">
                <c:forEach begin="${1}" end="${requestScope.num}" var="i">
                    <span onclick="location.href = 'tab?catid=${choose}&&page=${i}'">${i}</span>
                </c:forEach>
            </div>
        </div>
